...
$db = new Db;
$keagenan_exist = $db->selectQuery('tbl_penilaian', ['id_keagenan'])->column();
$data_keagenan = $db->selectQuery('tbl_keagenan', ['id'])->whereIn('id', $nama_perusahaan_exist, 'NOT IN')->column();
$data_kriteria = $db->selectQuery('tbl_kriteria', ['id'])->column();
$faker = Faker\Factory::create('id_ID');

$count = 0;
for ($i = 0; $i < sizeof($data_keagenan); $i++) {
    $nilai = [];
